...
const projects = [
  {
    ...
    description:
      "A real-time dashboard that aggregates and visualizes cybersecurity threats, helping analysts identify patterns and respond to incidents.",
  ...
  },
  {
    ...
    description:
      "A full-stack web app with multi-factor authentication and role-based access control, designed with a focus on preventing common web vulnerabilities.",
  ...
  },
  {
    ...
    description:
      "This very website, built with a focus on modern design principles and secure, clean code. The UI is a showcase of glassmorphism over an animated background.",
      ...
      <div className="content-wrapper">
        ...
        >
          <div className="p-4">
            ...
            <h2 className="display-5 text-white-50">
              I build and secure digital experiences.
            </h2>
            <p className="lead mt-4 mx-auto tagline">
              I'm a full-stack developer specializing in cybersecurity,
              passionately bridging the gap between elegant design and
            ...
            <Row className="align-items-center">
              <Col md={8}>
                <p className="lead">
                  ...
                  quickly evolved into a passion for building robust software.
                  That curiosity deepened as I realized the critical importance
                  of protecting what we build.
                </p>
                <p className="lead">
                  Based in Mumbai, I thrive on challenges, whether it's
                  designing a secure authentication system or performing a
                  vulnerability analysis. My goal is to craft applications that
                  are not just functional and beautiful, but also fortified
                  against threats.
                </p>
              </Col>
        ...
        >
          <Container className="text-center">
            ...
            <p className="lead mb-4">
              I operate at the intersection of web development and
              cybersecurity, building robust applications and prioritizing their
              security from the ground up.
            </p>

            <div className="my-5">
              <h3 className="text-info mb-4 d-flex align-items-center justify-content-center">
            ...
            <div className="my-5">
              <h3 className="text-info mb-4 d-flex align-items-center justify-content-center">
                <FaShieldAlt className="me-2" /> Cybersecurity
              </h3>
              <div className="d-flex flex-wrap justify-content-center">
            ...
            <div className="my-5">
              <h3 className="text-info mb-4 d-flex align-items-center justify-content-center">
                <FaTools className="me-2" /> Tools & Platforms
              </h3>
              <div className="d-flex flex-wrap justify-content-center">
        ...
        >
          <Container className="text-center">
            <Card
              className="text-white shadow-lg p-4 bg-dark contact-card border-0"
              style={{
        ...
        <footer className="text-center py-4">
          <Container>
            <p>
              &copy; {new Date().getFullYear()} Atharva Patil. Built with React.
            </p>
          </Container>
        </footer>
      </div>
